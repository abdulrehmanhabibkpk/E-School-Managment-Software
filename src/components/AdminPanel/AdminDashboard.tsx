...
const REVENUE_GRAPH_DATA = [
  { month: "Sep", revenue: 850000, expenses: 620000 },
  { month: "Oct", revenue: 920000, expenses: 640000 },
  { month: "Nov", revenue: 1100000, expenses: 710000 },
  { month: "Dec", revenue: 1450000, expenses: 800000 },
  { month: "Jan", revenue: 1680000, expenses: 850000 },
  { month: "Feb", revenue: 1950000, expenses: 910000 }
];
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
          ...
          {activeTab === "schools" && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {schools.map((sch: any) => (
                  <div key={sch.id} className={`p-6 rounded-3xl border ${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
