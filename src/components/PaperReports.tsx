      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shadow-sm sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-slate-800">Paper Reports & Analytics</h1>
          </div>
        </div>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-1 group w-full">
              ...
              <input 
                ...
                className="w-full pl-12 pr-16 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 transition-all font-bold"
              />
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-slate-800 text-white">
                  <tr>
                    <th className="py-4 px-6 font-bold border-r border-white/10 w-16 text-center">#</th>
                    <th className="py-4 px-6 font-bold border-r border-white/10">Student Name</th>
                    <th className="py-4 px-6 font-bold border-r border-white/10">Class / Grade</th>
                    <th className="py-4 px-6 font-bold border-r border-white/10">Subject</th>
                    <th className="py-4 px-6 font-bold border-r border-white/10 text-center w-32">Marks</th>
                    <th className="py-4 px-6 font-bold border-r border-white/10 w-1/3">Comments</th>
                  ...
                  {filteredReports.length > 0 ? (
                    filteredReports.map((report, idx) => (
                      <tr key={report.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="py-4 px-6 text-slate-600 text-sm whitespace-pre-wrap">{report.comments || 'No comments'}</td>
                        <td className="py-4 px-6 text-center">
