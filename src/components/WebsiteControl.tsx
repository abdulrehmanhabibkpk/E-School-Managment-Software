...
<\/script>
  ...
  const FatwaManagement = () => {
    ...
    const handleAddFatwa = () => {
      ...
      setFatawa([{ id: generateNumericId(), question: newQuestion.q, answer: newQuestion.a, category: newQuestion.cat, date: new Date().toLocaleDateString(), status: 'published' }, ...fatawa]);
  ...
  const ResultManagement = () => {
    ...
    const handleAddExam = () => {
      ...
      const updated = [{ ...newExam, id: generateNumericId() }, ...allResults];
  ...
  const GalleryManagement = () => {
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (file) {
        ...
        reader.onloadend = () => {
          const newImg = { id: generateNumericId(), url: reader.result as string, title: file.name.split('.')[0], category: selectedCategory };
